...
import {cilGarage,cilCheckCircle, cilToggleOff } from '@coreui/icons';
...
const [formData, setFormData] = useState({
  ...
  const fetchGroupData = async () => {
      try {
        const response = await axiosInstance.get(`/ledger-group/${id}`);
        console.log('Fetched data:', response.data);
        if (response.data) {
            setFormData(response.data);
          }
      } catch (error) {
        console.error('Error fetching ledger group data:', error);
      }
    };
      ...
      const handleSubmit = async (e) => {
        ...
        if (!formData.group_name) formErrors.group = 'group name is required';
        ...
        try {
          const response = await axiosInstance.put(`/ledger-group/${id}`,formData);
       ...
       <div className="user-details">
        <div className="input-box">
          <div className="details-container">
              <span className="details">Group name</span>
        ...
        <CInputGroupText className="input-icon">
         ...
         <CFormInput
          ...
          />
             ...
             {errors.group_name && <p className="error">{errors.group_name}</p>}
        </div>
      <div className="input-box">
      <div className="details-container">
