    ...
    <div className="table-container">
      <div className="table-header">
        ...
        <Link to='/units/add-unit'>
          <button className="new-user-btn" >+ New Unit</button>
        </Link>
      </div>
            ...
            currentRecords.length === 0 ? (
              ...
              currentRecords.map((unit, index) => (
                <tr key={index}>
                  ...
                  <Menu
                    id={`action-menu-${unit.id}`}
                    anchorEl={anchorEl}
                    open={menuId === unit.id}
                    onClose={handleClose}>
                     <Link to={`/units/update-unit/${unit.id}`}>
                    <MenuItem style={{ color: 'black'}}>Edit</MenuItem>
                     </Link>
                    <MenuItem onClick={() => handleDelete(unit.id)}>Delete</MenuItem>
                  </Menu>
                </td>
                </tr>
              ))
